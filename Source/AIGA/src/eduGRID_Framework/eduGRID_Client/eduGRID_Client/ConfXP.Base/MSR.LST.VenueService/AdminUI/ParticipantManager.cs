...
namespace MSR.LST.ConferenceXP.VenueService
{
    internal class ParticipantManager : MSR.LST.ConferenceXP.VenueService.ItemManager
    {
        ...
        public ParticipantManager()
        {
            ...
            base.list.Columns.Add(" E-Mail", 150, HorizontalAlignment.Left);
        ...
        {
            Participant selectedParticipant = ((Participant)list.SelectedItems[0].Tag);
            string removeStr = String.Format("Are you sure you want to delete the participant \"{0}\"?",
                selectedParticipant.Name);
            DialogResult dr = MessageBox.Show(this, removeStr, "Confirm Participant Delete", MessageBoxButtons.YesNo,
