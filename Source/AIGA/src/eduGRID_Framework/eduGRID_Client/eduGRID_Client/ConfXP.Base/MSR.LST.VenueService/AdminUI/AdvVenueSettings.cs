...
namespace MSR.LST.ConferenceXP.VenueService
{
    ...
    public class AdvVenueSettings : System.Windows.Forms.Form
    {
        ...
        {
            DialogResult dr = MessageBox.Show(this, String.Format(
                "Are you sure you want to replace the identifier \n" +
                "expression \"{0}\" with \n\"{1}\"?",
                expressionList.SelectedItem.ToString(), expressionInput.Text),
        ...
        private void deleteBtn_Click(object sender, System.EventArgs e)
        {
            DialogResult dr = MessageBox.Show(this, String.Format(
                ...
                "expression \"{0}\"?", expressionList.SelectedItem.ToString()),
