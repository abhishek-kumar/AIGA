...
namespace MSR.LST.ConferenceXP.VenueService
{
    ...
    internal class IconInput : System.Windows.Forms.UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.clearBtn.Text = "Restore Default";
            ...
            this.loadBtn.Text = "Choose Picture...";
        ...
        {
            DialogResult dr = MessageBox.Show(this, "Are you sure you want to replace the icon\n" +
                "for this venue with the default icon?", "Confirm Default Icon Restore",
