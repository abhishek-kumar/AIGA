...
namespace MSR.LST.ConferenceXP.ArchiveService
{
    ...
    public class ArchiveServer : MarshalByRefObject, IArchiveServer
    {
        ...
        public void Play( IPEndPoint venue, int[] streams )
        {
            try
            {
                lock(this)
                {
                    ...
                    eventLog.WriteEntry("Playing a recorded conference."
                        + "\n  Venue IP/Port: " + venue
        ...
        private void CheckForIPv6(IPEndPoint venue)
        {
                ...
                !Socket.OSSupportsIPv6)
            {
                throw new ArgumentException(
                    "The venue's address protocol is not understood by the server.\r\n" +
                    "This is due to using an IPv6 multicast address, which is " + 
                    "not supported by this server.\r\n" +
                    "Consult the ConferenceXP documentation for IPv6 support information.");
            }
        }
        ...
        private ConferenceRecorder CheckVenueForPlayback(IPEndPoint venue)
        {
            ...
            {
                throw new InvalidOperationException("A playback is ongoing in this venue.  Please choose"
                    + "\n another venue in which to record.");
            }
            // else...
        ...
        private void CheckVenueNotInUse(IPEndPoint venue)
        {
            ...
            if( sessionObj != null )
            {
                throw new InvalidOperationException("A playback or recording is ongoing in this venue."
                    + "\nPlease choose another venue in which to playback.");
            }
        }
