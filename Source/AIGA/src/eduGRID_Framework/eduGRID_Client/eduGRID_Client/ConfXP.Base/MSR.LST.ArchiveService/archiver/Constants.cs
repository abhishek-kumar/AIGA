...
namespace MSR.LST.ConferenceXP.ArchiveService
{
    ...
    {
        public static string    PersistenceCName = "ArchiveService@microsoft.com";      // name of us as a participant
        public static string    PersistenceName = "Archive Service";
        ...
        static Constants()
        {
            ...
            foreach (FieldInfo field in fields)
            {
                ...
                if (configOverride != null && configOverride != String.Empty)
                {
                    ...
                    object newValue = Convert.ChangeType(configOverride, newType);
