...
namespace MSR.LST.ConferenceXP.ArchiveService
{
    ...
    public class ConferencesTreeView : System.Windows.Forms.TreeView
    {
        ...
        public ConferencesTreeView()
        {
            ...
            img = Image.FromStream(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("MSR.LST.ConferenceXP.ArchiveService.icons.VenueIcon.gif"));
            this.conferenceImageIndex = ImageList.Images.Count;
            ImageList.Images.Add(img);

            img = Image.FromStream(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("MSR.LST.ConferenceXP.ArchiveService.icons.ParticipantIcon.gif"));
        ...
        public void Connect()
        {
            try
            {
                ...
                {
                    TreeNode newNode = new TreeNode("Conference: " + conf.Start.ToShortTimeString() + " - " + conf.Description);
                    newNode.Tag = conf;
                    ...
                    {
                        parent = this.Nodes.Add( conf.Start.Year.ToString() );
                    ...
                    if( tripSwitch || conf.Start.Month != lastConf.Start.Month )
                    {
                        ...
                        parent = parent.Nodes.Add( conf.Start.ToString("MMMM") );
                    ...
                    foreach( Participant part in participants )
                    {
                        ...
                        TreeNode partNode = new TreeNode("Participant: "+part.CName);
                        partNode.Tag = part;
                        ...
                        {
                            TreeNode streamNode = partNode.Nodes.Add("Stream: "+str.Name);
                            streamNode.Tag = str;
        ...
        public TreeNode[] GetConferencesInRange(DateTime start, DateTime end)
        {
            ...
            {
                int year = Int32.Parse(yearNode.Text);
                if( start.Year <= year && year <= end.Year )
                {
                    foreach( TreeNode monthNode in yearNode.Nodes )
                    {
                        ...
                        {
                            DateTime date = DateTime.Parse(dateNode.Text);
        ...
        private void EditConference(object sender, System.Windows.Forms.NodeLabelEditEventArgs e)
        {
            ...
            string time = "conference: " + conf.Start.ToShortTimeString().ToLower() + " - ";
            string newLabel;
            if( e.Label.ToLower().StartsWith(time) )
            {
            ...
            if( DBHelper.RenameConference( conf.ConferenceID, newLabel ) )
            {
                ...
                e.Node.Text = "Conference: " + conf.Start.ToShortTimeString() + " - " + newLabel;
        ...
        {
            string toolTipString = ""; // "" is the default
