...
namespace MSR.LST.ConferenceXP
{
    ...
    internal class OptionsForm : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.linkPrivacyPolicy.Location = new System.Drawing.Point(224, 176);
            ...
            // EmailTextBox
            // 
            this.EmailTextBox.Location = new System.Drawing.Point(64, 72);
            ...
            this.EmailLabel.Location = new System.Drawing.Point(16, 72);
            ...
            // NameTextBox
            // 
            this.NameTextBox.Location = new System.Drawing.Point(64, 48);
            ...
            this.IDLabel.Location = new System.Drawing.Point(64, 24);
        ...
        private void SelectImageButton_Click(object sender, System.EventArgs e)
        {
            ...
            if (d.ShowDialog() == DialogResult.OK && d.FileName != null)
            {
                ...
                {
                    MessageBox.Show(this, "File type cannot be read.", "Erroneous image file",
