...
namespace MSR.LST.ConferenceXP
{
    ...
    public class FAudioVideo : CapabilityForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(FAudioVideo));
            ...
            this.lblInfo.Font = new System.Drawing.Font("Franklin Gothic Demi", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
            ...
            // 
            this.imageListSendButtons.ColorDepth = System.Windows.Forms.ColorDepth.Depth24Bit;
            this.imageListSendButtons.ImageSize = new System.Drawing.Size(23, 21);
            ...
            // imageListConfig
            // 
            this.imageListConfig.ColorDepth = System.Windows.Forms.ColorDepth.Depth24Bit;
            this.imageListConfig.ImageSize = new System.Drawing.Size(74, 21);
            ...
            // 
            this.imageListPlayButtons.ColorDepth = System.Windows.Forms.ColorDepth.Depth24Bit;
            this.imageListPlayButtons.ImageSize = new System.Drawing.Size(23, 23);
        ...
        private const string StatusNormal = "Status: Normal";

        private const string LocalAudioSendStoppedMsg  = "My audio is not being sent.";
        private const string LocalVideoSendStoppedMsg  = "My video is not being sent.";

        private const string LocalAudioPlayStoppedMsg  = "The incoming audio is muted.";
        private const string LocalVideoPlayStoppedMsg  = "The incoming video is paused. Other participants can still see your video.";       
        
        private const string RemoteVideoSendStoppedMsg = "The incoming video is not being sent or network connectivity has been lost.";
        private const string RemoteAudioSendStoppedMsg = "The incoming audio is not being sent or network connectivity has been lost.";
        ...
        private void FAudioVideo_Load(object sender, System.EventArgs e)
        {
                ...
                // Initiator UI
            {
                ...
                toolTipAudioVideo.SetToolTip(this.pbLocalVideoButton, "Stop Sending My Video");
                toolTipAudioVideo.SetToolTip(this.pbLocalAudioButton, "Stop Sending My Audio");
                toolTipAudioVideo.SetToolTip(this.pbAudioButton, "Mute Audio");
        ...
        private void pbLocalVideoButton_Click(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                toolTipAudioVideo.SetToolTip(this.pbLocalVideoButton,"Send My Video");
            }
        ...
        private void pbAudioButton_Click(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                toolTipAudioVideo.SetToolTip(this.pbAudioButton,"Play Audio");
        ...
        private void pbLocalAudioButton_Click(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                toolTipAudioVideo.SetToolTip(this.pbLocalAudioButton,"Send My Audio");
            }
