...
namespace MSR.LST.ConferenceXP
{
    public class frmStopLight : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmStopLight));
            ...
            this.lblDescription.Text = @"This utility detects whether your computer is connected to Internet2 and to a multicast network. If your computer is not connected to a multicast network, you can participate in ConferenceXP conferences over unicast or by using the ConferenceXP Reflector Service.";
            // 
            // txtStatus
            // 
            ...
            this.txtStatus.Location = new System.Drawing.Point(16, 92);
            this.txtStatus.Name = "txtStatus";
            this.txtStatus.ReadOnly = true;
            this.txtStatus.Size = new System.Drawing.Size(508, 380);
            ...
            bool wellKnownHostDetected, string details)
        {
            ...
            if (i2Functional)
            {
                ...
                stoplightNotify.Text = "Internet2 functional.";
            }
            else if (multicastFunctional)
            {
                stoplightNotify.Icon = greenLight;
                stoplightNotify.Text = "Multicast functional.";
            }
            else if (networkReceiveDetected)
            {
                stoplightNotify.Icon = yellowLight;
                stoplightNotify.Text = "Receive only. Right-click for details.";
            }
            else
            {
                if (uptime.Minutes > 2)
                {
                    ...
                    stoplightNotify.Text = "Multicast non-functional. Right-click for details.";
                }
            }

            txtStatus.Text = string.Format("Multicast IPAddress: {0},\n\nNetwork Receive: {1},\n" +
                "Network Send: {2},\nMulticast Functional: {3},\nInternet2 Functional: {4},\n\n" +
                "Time Since IGMP Join: {5}:{6},\n\nDetails: {7}\n\n",
                detector.MulticastIPAddress.ToString(), networkReceiveDetected, networkSendDetected, multicastFunctional,
                i2Functional, uptime.Minutes, uptime.Seconds.ToString("00"), details);
        }
