...
namespace MSR.LST.ConferenceXP
{
    ...
    public class frmRecord : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmRecord));
        ...
        private string formatDuration(TimeSpan duration)
        {
            ...
            return duration.Hours.ToString("00") + ":" + duration.Minutes.ToString("00") + ":" + duration.Seconds.ToString("00");
        }
