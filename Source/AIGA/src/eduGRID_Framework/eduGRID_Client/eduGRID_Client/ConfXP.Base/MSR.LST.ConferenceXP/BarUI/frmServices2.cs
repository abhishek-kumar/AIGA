...
namespace MSR.LST.ConferenceXP
{
    ...
    internal class frmServices2 : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelServiceList.Size = new System.Drawing.Size(112, 16);
        ...
        {
            string key = textAddService.Text.ToLower();
        ...
        private void buttonEdit_Click(object sender, System.EventArgs e)
        {
            ...
            string editedService = textAddService.Text.ToLower();

            if ( ValidateUriAndShowError(editedService) && ValidateUniqueHost(editedService))
            {
                DialogResult dr = MessageBox.Show(this,
                    "Are you sure you want to replace the service host\n" +
                    "\"" + oldService + "\" with\n" +
                    "\"" + editedService + "\"?",
                    "Confirm Replace", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
        ...
        private void buttonDelete_Click(object sender, System.EventArgs e)
        {
            ...
            DialogResult dr = MessageBox.Show(this,
                "Are you sure you want to delete the service host\n" +
                "\"" + key + "\"?",
        ...
        private bool ValidateUniqueHost(string host)
        {
            ...
            {
                MessageBox.Show(this, "Please enter a "+serviceText.ConnectionType+
                    " not already in the list.", "Duplicate Host Name", 
        ...
        private bool ValidateUriAndShowError(string input)
        {
            ...
            if (!valid)
            {
                MessageBox.Show(this, "Please enter a valid "+serviceText.ConnectionType,
                    "Invalid "+serviceText.ConnectionType, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
