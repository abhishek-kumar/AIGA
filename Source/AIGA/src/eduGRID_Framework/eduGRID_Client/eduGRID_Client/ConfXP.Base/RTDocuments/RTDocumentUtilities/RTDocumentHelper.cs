...
namespace MSR.LST.RTDocuments.Utilities
{
    public class RTDocumentHelper : IDisposable
    {
        ...
        public RTDocument RTDocument
        {
            get
            {
                if (disposed) throw new ObjectDisposedException("RTDocumentHelper has been disposed");
                return rtDocument;
            }
        }
        #endregion
        ...
        public void AddPageToRTDocument( Page page )
        {
            ...
            if (tn == null)
            {
                throw new InvalidOperationException("TOCNode not found for page " + page.Identifier + ", this would create an 'abandoned' page.");
            }
        ...
        public Guid TOCNodeIdentifierToPageIdentifier ( Guid tocNodeIdentifier )
        {
            ...
            if (tocNode.Resource != null)
            {
                ...
                throw new Exception("TOCNode.Resource is pointing to an object that is not a Page");
            }
            ...
            if (page == null)
            {
                throw new Exception("Page not found for TOCNode");
            }
