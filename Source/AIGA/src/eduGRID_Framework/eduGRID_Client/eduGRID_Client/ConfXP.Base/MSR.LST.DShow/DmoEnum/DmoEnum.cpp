            ...
            public ref class DMOEnumerator
            {
                public:
                        ...
                        System::Boolean inputMediaType)
                    {
                        ...
                        //
                        // Ridiculous casting necessary to convert System::Guid to GUID
                        //

                        // Create the partial media type
                        DMO_PARTIAL_MEDIATYPE partialMT;
                        partialMT.type = *reinterpret_cast<GUID*>(&majorType);
                        partialMT.subtype = *reinterpret_cast<GUID*>(&subType);
                        ...
                        IEnumDMO* pEnum = NULL; 
                        HRESULT hr = DMOEnum(
                            *reinterpret_cast<GUID*>(&category),    // Category
