...
namespace MSR.LST.ConferenceXP
{
    ...
    public abstract class PresentationToOneNoteCapability : Capability, ICapabilityViewer
    {
        ...
        private void PageReceived(Page page)
        {
            ...
            if( parentNode == null )
                throw new InvalidOperationException("Parent TOCNode for Page not found.");
        ...
        internal void SyncToPage( object sender, EventArgs e )
        {
            if( crntPage != Guid.Empty && this.crntONFile != null )
            {
                ...
                LogAsLastCommand("importer.NavigateToPage(\""+crntONFile+"\", \""+navTo+"\");");
        ...
        {
            XmlTextWriter xml = new XmlTextWriter( new StringWriter(importData) );
    ...
    public class PresentationToOneNote2003Capability : PresentationToOneNoteCapability
    {
        ...
        public static new bool IsRunable
        {
            get
            {
                ...
                string warningKey = "OneNote 2003 Warning";
                string msg = "ConferenceXP has detected OneNote 2003 is installed.  CXP offers special" +
                    "\n functionality with OneNote, but OneNote 2003 Service Pack 1 must be installed." +
                    "\n You can go to officeupdate.microsoft.com to install OneNote SP1." +
                    "\n\n NOTE that you MUST run OneNote once to initialize it before CXP will recognize it." +
                    "\n\n After installing OneNote SP1, the OneNote Capability will be available" +
                    "\n under Settings -> RTDocument Viewer.";
    ...
    public class PresentationToOneNote2007Capability : PresentationToOneNoteCapability
    {
        ...
        public static new bool IsRunable
        {
            get
            {
                ...
                string warningKey = "OneNote 2007 Warning";
                string msg = "ConferenceXP has detected OneNote 2007 is installed but there was" +
                    "\n an error initializing it.  Please make sure you have the most recent" +
                    "\n updates from officeupdate.microsoft.com." +
                    "\n\n NOTE that you MUST run OneNote once to initialize it before CXP will recognize it." +
                    "\n\n After updates, the OneNote Capability will be available" +
                    "\n under Settings -> RTDocument Viewer.";
