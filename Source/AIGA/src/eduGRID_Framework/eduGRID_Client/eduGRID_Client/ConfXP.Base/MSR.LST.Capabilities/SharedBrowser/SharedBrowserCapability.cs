...
namespace MSR.LST.ConferenceXP
{
    ...
    public class SharedBrowser : Capability, ICapabilitySender, ICapabilityViewer
    {
        ...
        private void HookAllEvents()
        {
            ...
            ie.StatusTextChange += new DWebBrowserEvents2_StatusTextChangeEventHandler(StatusTextChange);
        ...
        {
            Log(new object[]{"FileDownload:", active, cancel});
        }
...
//        }
        ...
        private void StatusTextChange(string status)
        {
            // As you drag the mouse around a page and over links, the status bar updates
            // Log(new object[]{"StatusTextChange:", status});
        }
