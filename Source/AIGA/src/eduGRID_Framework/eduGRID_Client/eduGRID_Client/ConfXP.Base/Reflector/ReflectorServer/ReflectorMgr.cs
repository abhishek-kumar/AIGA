...
namespace MSR.LST.ConferenceXP.ReflectorService
{
    ...
    public class ReflectorMgr
    {
        ...
        /// <summary>
        /// The port number which the RegistrarServer listens for join and leave requests.
        /// On the client side this port number is hard coded and can be overrided in UI
        /// </summary>
        private static int registrarServerPort = 8083;

        public static int RegistrarServerPort
        {
            get { return registrarServerPort; }
        }
        ...
        /// </summary>
        private RegistrarServer regServer = null;
    ...
    public class ReflectorSockets
    {
        ...
        public void DisposeAll()
        {
            ...
            {
                throw new Exception("Socket Disposing Error", e);
