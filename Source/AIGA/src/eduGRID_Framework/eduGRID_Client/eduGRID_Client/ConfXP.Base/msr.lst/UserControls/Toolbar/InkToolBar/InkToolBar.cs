...
namespace MSR.LST.Controls
{
    ...
    public class InkToolBar : System.Windows.Forms.ToolBar
    {
        ...
        public InkOverlay InkOverlay
        {
            ...
            {
                inkOverlay = value;
                // Init default color to black, set button to selected
        ...
        private void InitializeMenus()
        {
            ...
            this.menuItemPenColors[0].Text = "B&lue";
            ...
            this.menuItemPenColors[1].Text = "&Black";
            ...
            this.menuItemPenColors[3].Text = "&Yellow";
            ...
            this.menuItemHighlighterColors[1].Text = "&Lime";
            ...
            this.menuItemHighlighterColors[2].Text = "&Blue";
        ...
        public Microsoft.Ink.DrawingAttributes PenAttributes
        {
            ...
            set 
            {
                ...
                SetPen(m_penAttributes.Color.Name, true);
                UpdatePenMenus();
            }
        }
        ...
        public Microsoft.Ink.DrawingAttributes HighlighterAttributes
        {
            ...
            set 
            {
                ...
                // Sync the color in the button icon/drop-down
                SetHighlighter(m_highlighterAttributes.Color.Name, true);
        ...
        public void DeleteAllStrokes()
        {
            ...
            catch (System.ArgumentException)
            {
                MessageBox.Show(
                    this, 
                    "You are trying to draw while the page is still changing. Your stroke will be ignored.", 
                    "Information", 
        ...
        private void MenuItemPenColors_Click(object sender, System.EventArgs e)
        {
            ...
            string colorName = GetCurrentColorPen((ImageMenuItem)sender);
            // Set the pen
            SetPen(colorName, true);
        }
        ...
        /// </summary>
        /// <param name="imgMenuItem">The image menu item.</param>
        private string GetCurrentColorHighlighter(ImageMenuItem imgMenuItem)
        {
            //Get the menu item's index
            int index = imgMenuItem.Index;
            // Obtain the menu text without the shortcut ampersand: '&'.
            string colorName = StripAmpersandFromMenuText(menuItemHighlighterColors[index].Text);
            //Check mark the relative item
        ...
        {
            string colorName = GetCurrentColorHighlighter((ImageMenuItem)sender);
            // Set the highlighter
            SetHighlighter(colorName, true);
        }
