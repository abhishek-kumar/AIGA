    ...
    abstract class ImageMenuItem : System.Windows.Forms.MenuItem
    {
        ...
        protected override void OnDrawItem(System.Windows.Forms.DrawItemEventArgs e)
        {
            if (this.Visible)
            {
                ...
                int idxOfAmpersand = this.Text.IndexOf('&');
                if (idxOfAmpersand >= 0)
                    menuText = this.Text.Remove(idxOfAmpersand, 1);
                ...
                DrawImage(e.Graphics, m_image, rectImage, Color.Red, Color.FromName(menuText), Color.White, backColor);
            }
        }
